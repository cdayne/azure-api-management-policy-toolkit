...
| ✅ | SendServiceBusMessage | SendServiceBusMessageHandler.cs | `emulator/tests-send-service-bus-message` |
| ✅ | AzureOpenAiSemanticCacheStore | AzureOpenAiSemanticCacheStoreHandler.cs | `emulator/tests-azure-openai-semantic-cache-store` |
